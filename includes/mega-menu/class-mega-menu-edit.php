...
class EFramework_Mega_Menu_Edit_Walker extends Walker_Nav_Menu_Edit
{
    ...
    function get_fields($item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-cms-megaprofile-<?php echo esc_attr($item_id); ?>">
                ...
                <select id="edit-menu-item-cms-megaprofile-<?php echo esc_attr($item_id); ?>" class="widefat"
                        name="menu-item-cms-megaprofile[<?php echo esc_attr($item_id); ?>]">
    ...
    <?php endif; ?>
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-cms-icon-<?php echo esc_attr($item_id); ?>">
                ...
                <select id="edit-menu-item-cms-icon-<?php echo esc_attr($item_id); ?>" class="widefat cms-icon-picker"
                        name="menu-item-cms-icon[<?php echo esc_attr($item_id); ?>]">
    ...
    <?php endif; ?>
        ...
        <p class="description description-wide">
            <label for="menu-item-cms-onepage<?php echo esc_attr($item_id); ?>">
                ...
                <select id="menu-item-cms-onepage-<?php echo esc_attr($item_id); ?>"
                        class="widefat menu-item-cms-onepage"
                        name="menu-item-cms-onepage[<?php echo esc_attr($item_id); ?>]">
                    <option value="no-one-page" <?php selected(esc_attr($item->cms_onepage), 'no-one-page') ?>><?php esc_html_e('No', CMS_TEXT_DOMAIN) ?></option>
                    <option value="is-one-page" <?php selected(esc_attr($item->cms_onepage), 'is-one-page') ?>><?php esc_html_e('Yes', CMS_TEXT_DOMAIN) ?></option>
                </select>
            </label>
        </p>
    <?php endif; ?>
    ...
    function cms_iconpicker_fontawesome()
    {
