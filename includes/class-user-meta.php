...
//
        ...
        protected function optimize_default_args()
        {
            $this->default_args = array(
                ...
                'templates_path'       => cmssuperheroes()->path('APP_DIR') . '/templates/panel-post-meta'
            );
        }
        ...
        function panel_scripts()
        {
            ...
            wp_enqueue_style('cms-metabox', cmssuperheroes()->path('APP_URL') . '/assets/css/metabox' . Redux_Functions::isMin() . '.css', array(), 'all');
            wp_enqueue_script('cms-metabox', cmssuperheroes()->path('APP_URL') . '/assets/js/metabox' . Redux_Functions::isMin() . '.js', array('jquery', 'redux-js'), 'all', true);
        }
